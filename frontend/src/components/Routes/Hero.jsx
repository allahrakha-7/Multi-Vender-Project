...
function Hero() {
  return (
    <div
      className="relative min-h-[70vh] my-8 sm:min-h-[80vh] lg:min-h-[90vh] w-full bg-no-repeat flex items-center justify-center sm:justify-start"
      style={{
    ...
    >
      <div className="w-11/12 sm:w-10/12 md:w-9/12 lg:w-3/5 xl:w-1/2 font-[Georgia] text-center sm:text-left px-3 sm:px-8">
        <h1 className="text-3xl sm:text-2xl md:text-4xl lg:text-3xl font-black italic text-gray-950 leading-tight sm:leading-[1.2] capitalize">
          Welcome to Vendify <br />Your best ever
          shopping platform
        </h1>

        <p className="pt-6 mb-6 sm:pt-5 text-sm sm:text-base md:text-lg lg:text-xl text-white font-[400] italic leading-relaxed sm:leading-8">
